...
{
	std::string vertexShaderSource = loadShaderSource("./ressources/shaders/vertex.glsl");
	std::string fragmentShaderSource = loadShaderSource("./ressources/shaders/fragment.glsl");
